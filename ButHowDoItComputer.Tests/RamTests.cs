...
//             _byteRegisterFactory = new ByteRegisterFactory(_byteMemoryGateFactory, new ByteEnabler(_and, _byteFactory),
//                 _byteFactory);
//
...
//
//             for (var i = 0; i < address.Count; i++) Assert.AreEqual(address[i], _ram.MemoryAddressRegister.Data[i]);
//         }
//     }
// }