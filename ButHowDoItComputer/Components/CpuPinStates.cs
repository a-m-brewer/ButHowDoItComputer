...
namespace ButHowDoItComputer.Components
{
    public class CpuPinStates<TBusDataType> : ICpuPinStates<TBusDataType> where TBusDataType : IList<bool>
    {
        ...
        private bool Step1E => Step1 && PinStates.ClockOutput.ClkE;
        private bool Step1S => Step1 && PinStates.ClockOutput.ClkS;

        private bool Step2 => PinStates.StepperOutput[1];
        private bool Step2E => Step2 && PinStates.ClockOutput.ClkE;
        private bool Step2S => Step2 && PinStates.ClockOutput.ClkS;

        private bool Step3 => PinStates.StepperOutput[2];
        private bool Step3E => Step3 && PinStates.ClockOutput.ClkE;
        private bool Step3S => Step3 && PinStates.ClockOutput.ClkS;

        private bool Step4 => PinStates.StepperOutput[3];
        private bool Step4E => Step4 && PinStates.ClockOutput.ClkE;
        private bool Step4S => Step4 && PinStates.ClockOutput.ClkS;

        private bool Step5 => PinStates.StepperOutput[4];
        private bool Step5E => Step5 && PinStates.ClockOutput.ClkE;
        private bool Step5S => Step5 && PinStates.ClockOutput.ClkS;

        private bool Step6 => PinStates.StepperOutput[5];
        private bool Step6E => Step6 && PinStates.ClockOutput.ClkE;
        private bool Step6S => Step6 && PinStates.ClockOutput.ClkS;
        ...
        {
            // setup
            var step4AndIr0 = Step4 && _instruction[0];
        ...
        {
            // setup
            var step43X80 = Step4 && PinStates.ThreeXEight[0];
            var step43X81 = Step4 && PinStates.ThreeXEight[1];
        ...
        {
            // setup
            var step43X82 = Step4 && PinStates.ThreeXEight[2];
        ...
        {
            // setup
            var step43X83 = Step4 && PinStates.ThreeXEight[3];
        ...
        {
            // setup
            var step43X84 = Step4 && PinStates.ThreeXEight[4];
        ...
        {
            // setup
            var step43X85 = Step4 && PinStates.ThreeXEight[5];
        ...
        {
            // setup 
            var step43X86 = Step4 && PinStates.ThreeXEight[6];
        ...
        {
            // setup
            var step43X87Ir4 = Step4 && PinStates.ThreeXEight[7] && _instruction[4];
        ...
        {
            // setup
            var step5AndIr0 = Step5 && _instruction[0];
        ...
        {
            // setup
            var storeFlag = Step5 && PinStates.ThreeXEight[0];
            var loadFlag = Step5 && PinStates.ThreeXEight[1];
        ...
        {
            // setup
            var step53X82 = Step5 && PinStates.ThreeXEight[2];
        ...
        {
            // setup
            var step53X84 = Step5 && PinStates.ThreeXEight[4];
        ...
        {
            // setup
            var step53X85 = Step5 && PinStates.ThreeXEight[5];
        ...
        {
            var step53X87NotIr4 = Step5 && PinStates.ThreeXEight[7] && _not.Apply(_instruction[4]);
        ...
        {
            PinStates.Op.One = Step5 && _instruction[0] && _instruction[1];
            PinStates.Op.Two = Step5 && _instruction[0] && _instruction[2];
            PinStates.Op.Three = Step5 && _instruction[0] && _instruction[3];
        }
        ...
        {
            // setup
            var notAndIr123 = _not.Apply(_instruction[1] && _instruction[2] && _instruction[3]);
            var step6AndIr0AndNotAndIr123 = Step6 && _instruction[0] && notAndIr123;
        ...
        {
            // setup
            var step63X82 = Step6 && PinStates.ThreeXEight[2];
        ...
        {
            var cAndIr4 = _caez.C && _instruction[4];
            var aAndIr5 = _caez.A && _instruction[5];
            var eAndIr6 = _caez.E && _instruction[6];
            var zAndIr7 = _caez.Z && _instruction[7];

            // setup
            var orCaez = _or.ApplyParams(cAndIr4, aAndIr5, eAndIr6, zAndIr7);
            var step63X85AndCaez = 
                Step6 &&
        ...
        public void UpdateGeneralPurposeRegisters(bool regAEnable, bool regBEnable, bool regBSet)
        {
            ...
            var r0Ea = decoderEnableRegA[0] && regAEnable && clkE;
            var r1Ea = decoderEnableRegA[1] && regAEnable && clkE;
            var r2Ea = decoderEnableRegA[2] && regAEnable && clkE;
            var r3Ea = decoderEnableRegA[3] &&regAEnable && clkE;

            var r0Eb = decoderEnableRegB[0] && regBEnable && clkE;
            var r1Eb = decoderEnableRegB[1] && regBEnable && clkE;
            var r2Eb = decoderEnableRegB[2] && regBEnable && clkE;
            var r3Eb = decoderEnableRegB[3] &&regBEnable && clkE;

            var r0S = decoderSetRegB[0] && regBSet && clkS;
            var r1S = decoderSetRegB[1] && regBSet && clkS;
            var r2S = decoderSetRegB[2] && regBSet && clkS;
            var r3S = decoderSetRegB[3] && regBSet && clkS;
        ...
        private void Update3X8()
        {
            ...
            PinStates.ThreeXEight =
                _byteFactory.Create(threeXEightDecoded.Select(bit => notAluFlag && bit).ToArray());
        }
        ...
        {
            return PinStates.ClockOutput.ClkE && update;
        }

        private bool ClkSAnd(bool update)
        {
            return PinStates.ClockOutput.ClkS && update;
        }
    }
