...
namespace ButHowDoItComputer.Utils
{
    public static class OpCodes
    {
        ...
        public static Op Shr => new Op { One = false.ToBit(), Two = true.ToBit(), Three = false.ToBit() };
        public static Op Shl => new Op { One = false.ToBit(), Two = false.ToBit(), Three = true.ToBit() };
